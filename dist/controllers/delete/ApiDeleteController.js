...
const BaseDeleteController_1 = __importDefault(require("./BaseDeleteController"));
class ApiDeleteController extends BaseDeleteController_1.default {
    handleRequest() {
...
module.exports = ApiDeleteController;
